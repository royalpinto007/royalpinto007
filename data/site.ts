export const siteConfig = {
  ...
  projects: [
    ...
    },
    {
      ...
      features: [
        "Velocity, dye, and pressure in float textures with 20 Jacobi iterations per frame",
        "Pointer-coupled splats plus self-stirring idle currents",
        "Four dye palettes, pause, reset, and a live fps readout",
        "One self-contained HTML file, no dependencies, no build step",
      ],
    ...
    },
    {
      ...
      features: [
        "Twelve solver steps per frame on ping-pong float textures",
        "Four feed/kill presets: Coral, Mitosis, Spots, Worms",
        "Click and drag seeding with symmetry-breaking noisy masks",
        "One self-contained HTML file, no dependencies, no build step",
      ],
      tech: ["WebGL2", "GPGPU", "GLSL", "Simulation"],
      featured: false,
    ...
    },
    {
      ...
      features: [
        "Distance-estimated marching with tetrahedron normals and cosine palettes",
        "Self-orbiting camera with pointer-steered orbit and light",
        "Three palettes, procedural stars, pause, reset, and a live fps readout",
        "One self-contained HTML file, no dependencies, no build step",
      ],
    ...
    },
    {
      ...
      features: [
        "Particle state in float textures advected through an analytic flow plus pointer vortices",
        "Additive trail map with decay, three dye palettes, warmed-up first paint",
        "Pause, reset, live fps readout, and self-stirring idle currents",
        "One self-contained HTML file, no dependencies, no build step",
      ],

...
AI and product engineer. I build and ship, fast and daily.
...
- Security: [MCP-audit](https://github.com/AgentPostmortem/MCP-audit) · [Skill-audit](https://github.com/AgentPostmortem/Skill-audit) · [Injection-arena](https://github.com/AgentPostmortem/Injection-arena)
- Token cost: [Ctxlens](https://github.com/AgentPostmortem/Ctxlens) · [Ctxtrim](https://github.com/AgentPostmortem/Ctxtrim) · [tokencut](https://github.com/AgentPostmortem/tokencut)
...
[Explore the gallery](https://facetworks.signalizeai.org) of 35 independent projects: 18 distinctive websites and 17 interactive experiences. Find a direction you love and [commission a custom build](https://hire.agentpostmortem.com).

Latest: [Forklift Certified. Somehow.](https://fly-forklift.signalizeai.org), an anatomical fly operating a miniature forklift, lifting, reversing and stacking a pallet. Authored 3D choreography with leg IK and a real browser demo, not a trained policy. Also explore [Not a Robot. Just a Fly.](https://fly-captcha.signalizeai.org), [Rent My Screen](https://rentmyscreen.xyz), with payments coming soon, and [Internet CEO](https://internetceo.lol).
